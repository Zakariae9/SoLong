SRCS = check_is_map_surrounded_by_walls.c checkmap1.c checkmap0.c main.c free.c join.c display_map_in_window.c start_game.c exit.c\
motions.c
...
libft1/ft_toupper.c libft1/ft_tolower.c libft1/ft_strchr.c libft1/ft_strrchr.c libft1/ft_strcmp.c libft1/ft_memchr.c libft1/ft_memcmp.c\
...
$(NAME):$(OBJS) $(OBJS_LIBFT) $(OBJS_GET)
	cc  $(OBJS) $(FLAGS) $(OBJS_LIBFT) $(MLX) $(OBJS_GET) -o $(NAME)
